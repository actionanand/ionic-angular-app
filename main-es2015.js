...
const routes = [
    { path: '', redirectTo: 'recipe', pathMatch: 'full' },
    {
        ...
        children: [
            {
                path: '', loadChildren: () => Promise.all(/*! import() | recipe-recipe-module */[__webpack_require__.e("common"), __webpack_require__.e("recipe-recipe-module")]).then(__webpack_require__.bind(null, /*! ./recipe/recipe.module */ "./src/app/recipe/recipe.module.ts")).then(m => m.RecipePageModule)
            },
            {
                path: ':recipeId',
                loadChildren: () => Promise.all(/*! import() | recipe-recipe-details-recipe-details-module */[__webpack_require__.e("common"), __webpack_require__.e("recipe-recipe-details-recipe-details-module")]).then(__webpack_require__.bind(null, /*! ./recipe/recipe-details/recipe-details.module */ "./src/app/recipe/recipe-details/recipe-details.module.ts")).then(m => m.RecipeDetailsPageModule)
            }
        ]
    }
];
